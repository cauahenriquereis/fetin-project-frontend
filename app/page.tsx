...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-100 flex flex-col items-center justify-center gap-10 overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[400px] bg-[#dff0f4] rounded-full -translate-x-40 -translate-y-40"></div>

      {/* Bottom-right decorative circle */}
      <div className="absolute bottom-0 right-0 w-[550px] h-[500px] bg-[#dff0f4] rounded-full translate-x-35 translate-y-35"></div>
